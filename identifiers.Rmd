...
<!-- Now I'll make the data "wider" for easier lookup in Excel or similar types of tables. -->
<!-- I'm doing this the same way I did it for the first three steps above for the -->
<!-- `equiv_vTagID_PIT` data frame. In this case, however, I'm  -->
...
```{r saveWide_vTagID_PIT, eval = FALSE}
